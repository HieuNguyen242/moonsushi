...
if ( $admin_title === $title ) {
	...
	$admin_title = sprintf( __( '%s &#8212; Admin Portal' ), $title );
} else {
	/* translators: Admin screen title. 1: Admin screen name, 2: Network or site name. */
	$admin_title = sprintf( __( '%1$s &lsaquo; %2$s &#8212; Admin Portal' ), $title, $admin_title );
}
...
<style>
	...
	.edit-php.post-type-fooditem .wrap h1.wp-heading-inline, .edit-php.post-type-fooditem .wrap > a.page-title-action {
