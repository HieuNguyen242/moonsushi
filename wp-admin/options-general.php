...
<tr>
<th scope="row"><label for="food_order_closed"><?php _e( 'Food Order Closed' ); ?></label></th>
<td><input name="food_order_closed" type="checkbox" id="food_order_closed" value="1" <?php checked( '1', get_option( 'food_order_closed' ) ); ?> />
<p class="food_order_closed" id="food_order_closed"></p></td>
</tr>

<tr>
<th scope="row"><label for="limited_use_enabled"><?php _e( 'Limited Use Enabled' ); ?></label></th>
<td><input name="limited_use_enabled" type="checkbox" id="limited_use_enabled" value="1" <?php checked( '1', get_option( 'limited_use_enabled' ) ); ?> />
<p class="limited_use_enabled" id="limited_use_enabled"></p></td>
</tr>
