...
if ( ! class_exists( 'RP_Admin_Assets', false ) ) :
  ...
  class RP_Admin_Assets {
    ...
    public function admin_styles() {
      ...
      wp_register_style( 'rpress_admin_icon_styles', RP_PLUGIN_URL . '/assets/css/admin-icons.css', array(), RP_VERSION_CUSTOM );
      wp_register_style( 'rpress_admin_styles', RP_PLUGIN_URL . 'assets/css/admin.css', array('select2'), RP_VERSION_CUSTOM );
      wp_register_style( 'select2', RP_PLUGIN_URL . 'assets/css/select2.min.css', array(), RP_VERSION_CUSTOM );
      wp_register_style( 'toast', RP_PLUGIN_URL . '/assets/css/jquery.toast.css', array(), RP_VERSION_CUSTOM );
      wp_register_style( 'timepicker', plugins_url( 'assets/css/jquery.timepicker.css', RP_PLUGIN_FILE ), array(), RP_VERSION_CUSTOM );
      wp_register_style( 'rpress-addon-bootstrap-style', plugins_url( 'assets/css/rpress-bootstrap.css', RP_PLUGIN_FILE ), array(), RP_VERSION_CUSTOM);
      wp_register_style( 'jquery-chosen', plugins_url( 'assets/css/chosen.min.css', RP_PLUGIN_FILE ), array(), RP_VERSION_CUSTOM );
      wp_register_style( 'backbone-modal', plugins_url( 'assets/css/rpress-backbone-modal.css', RP_PLUGIN_FILE ), array(), RP_VERSION_CUSTOM );
    ...
    public function admin_scripts() {
      ...
      wp_register_script( 'jquery-tiptip', RP_PLUGIN_URL . 'assets/js/jquery-tiptip/jquery.tipTip' . $suffix . '.js', array( 'jquery' ), RP_VERSION_CUSTOM, true );
      wp_register_script( 'select2', RP_PLUGIN_URL . 'assets/js/select2/select2' . $suffix . '.js', array( 'jquery' ), RP_VERSION_CUSTOM, true );
      wp_register_script( 'jquery-blockui', RP_PLUGIN_URL . 'assets/js/jquery-blockui/jquery.blockUI' . $suffix . '.js', array( 'jquery' ), RP_VERSION_CUSTOM, true );
      wp_register_script( 'rp-backbone-modal', RP_PLUGIN_URL . 'assets/js/admin/backbone-modal.js', array( 'underscore', 'backbone', 'wp-util' ), RP_VERSION_CUSTOM );
      wp_register_script( 'timepicker', RP_PLUGIN_URL . 'assets/js/timepicker/jquery.timepicker.js', array( 'jquery' ), RP_VERSION_CUSTOM );
      wp_register_script( 'rp-admin-meta-boxes', RP_PLUGIN_URL . 'assets/js/admin/meta-boxes' . $suffix . '.js', array( 'jquery', 'jquery-ui-datepicker', 'jquery-ui-sortable', 'select2', 'jquery-tiptip', 'jquery-blockui' ), RP_VERSION_CUSTOM );
      wp_register_script( 'rpress-orders', RP_PLUGIN_URL . 'assets/js/admin/rp-orders' . $suffix . '.js', array( 'jquery', 'rp-backbone-modal' ), RP_VERSION_CUSTOM );
      wp_register_script( 'jquery-toast', RP_PLUGIN_URL . 'assets/js/admin/jquery.toast.js', array( 'jquery' ), RP_VERSION_CUSTOM );
      wp_register_script( 'rp-admin', RP_PLUGIN_URL . 'assets/js/admin/rp-admin.js', $admin_deps, RP_VERSION_CUSTOM );
      wp_register_script( 'jquery-chosen', RP_PLUGIN_URL . 'assets/js/jquery-chosen/chosen.jquery' . $suffix . '.js', array( 'jquery' ), RP_VERSION_CUSTOM );
      ...
      wp_register_script( 'rpress-admin-scripts-compatibility', RP_PLUGIN_URL . '/assets/js/admin/admin-backwards-compatibility' . $suffix . '.js', array( 'jquery', 'rp-admin' ), RP_VERSION_CUSTOM );
      ...
      if ( in_array( $screen_id, array( 'fooditem', 'edit-fooditem' ) ) ){
        ...
        wp_register_script( 'rp-admin-fooditem-meta-boxes', RP_PLUGIN_URL . 'assets/js/admin/meta-boxes-fooditem' . $suffix . '.js', array( 'rp-admin-meta-boxes' ), RP_VERSION_CUSTOM );
    ...
    public function register_styles() {
      ...
      wp_register_style( 'rpress-admin', $css_dir . 'rpress-admin' . $suffix . '.css', array(), RP_VERSION_CUSTOM);
      ...
      wp_register_style('admin-icons', $css_dir . 'admin-icons' . $suffix . '.css', array(), RP_VERSION_CUSTOM);
